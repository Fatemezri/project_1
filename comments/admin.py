...
# --- Main Admin Site for Superusers ---
class MyAdminSite(admin.AdminSite):
    ...
    def has_permission(self, request: HttpRequest) -> bool:
        # Only superusers can access this site
...
class ModeratorAdminSite(admin.AdminSite):
    ...
    def approve_comment(self, request, comment_id):
        # Using GET for simplicity to avoid CSRF for these specific actions
        try:
    ...
    def send_report_view(self, request, comment_id):
        ...
        if request.method == 'POST':
            ...
            if report_text:
                ...
                comment.status = 'approved'
                # Saving the model will trigger the signal
    ...
    def notifications_view(self, request):
        # We'll keep this view as 'notifications' for now, but it will show reports
